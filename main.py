...
if __name__ == '__main__':
    ...
    # նախորդ բագը լուծված է, forward և backward ֆունկցիաները փոխում էին մուտքային և ելքային նախնական տվյալները, 
    # դրա հետևանքով էլ 2րդ լեվելի վրա արդեն թրեինը լինում էր աղավաղված: Լուծվել է հետևյալ կերպ՝ ուղարկում ենք ոչ թե 
    # իրական տվյալները այլ կոպիաները, անհրաժեշտ է վերանայել կոպիաների տրամաբանությունը
    # ավելացում !!!!!!!!!!  ներկայումս աշխատող ալգորիթմը էֆեկտիվ է այն ժամանակ, երբ լեվելի փոխվելուց թարմացվում են թրեյնի 
    # տվյալները, սակայն որոշ(թվով մեծ) դեպքերում այն տեղի չի ունենում.... լուծում::: պետք է կոպիա անել մինչև back և forward
    # ուղարկելը, այդ դեպքում այլևս անհրաժեշտ չի լինի լեվելը փոխելուց կատարել թարմացում(քանի որ թարմացվում է անմիջապես 
    # փոփոխվելուց հետո)